  ...
  navItems: NavItem[] = [
    {
      ...
      adminOnly: true,
      subItems: [
        { name: "nav.statistics", path: "/statistics" },
    ...
    },
    {
      ...
      name: "nav.calendar",
      path: "/calendar",
      // Accessible by both admin and operators
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>`,
    ...
    },
    {
      ...
      adminOnly: true,
      subItems: [
        { name: "nav.formElements", path: "/form-elements", pro: false }
      ],
    },
    {
      name: "nav.tables",
      ...
      adminOnly: true,
      subItems: [
        { name: "nav.basicTables", path: "/basic-tables", pro: false },
      ],
    },
    {
      name: "nav.pages",
      ...
      adminOnly: true,
      subItems: [
        { name: "nav.blankPage", path: "/blank", pro: false },
        { name: "nav.404Error", path: "/error-404", pro: false },
      ],
    },
  ];
  // Others nav items
  othersItems: NavItem[] = [
    {
      ...
      adminOnly: true,
      subItems: [
        { name: "nav.lineChart", path: "/line-chart", pro: false },
        { name: "nav.barChart", path: "/bar-chart", pro: false },
      ],
    },
    {
      ...
      adminOnly: true,
      subItems: [
        { name: "nav.alerts", path: "/alerts", pro: false },
        { name: "nav.avatar", path: "/avatars", pro: false },
        { name: "nav.badge", path: "/badge", pro: false },
        { name: "nav.buttons", path: "/buttons", pro: false },
        { name: "nav.images", path: "/images", pro: false },
        { name: "nav.videos", path: "/videos", pro: false },
      ],
    },
    {
      ...
      adminOnly: true,
      subItems: [
        { name: "nav.signIn", path: "/signin", pro: false },
        { name: "nav.signUp", path: "/signup", pro: false },
      ],
    },
  ];
